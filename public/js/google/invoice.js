...
auth.onAuthStateChanged(user => {
	...
	if (user.displayName && user.email) {
		...
		if(user.email.includes('yahoo.com')){
			...
			linkBtn.innerHTML = `
				Verify <img src="img/partners/yahoo.png">
			`;
		} else {
			vpn.innerHTML = `
				View Profile
			...
			linkBtn.innerHTML = `
				Verify <img src="img/partners/google.png">
			`;
		}
		...
		linkBtn.innerHTML = `
			Verify <img src="img/partners/emails.png">
		`;
		linkBtn.addEventListener('click', sendEmail);
		...
		linkBtn.innerHTML = `
			Linked <img src="img/partners/phone.png">
		`;
	}  else if(user.phoneNumber && !user.displayName) {
